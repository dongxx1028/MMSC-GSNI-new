...
% When beta1=0.002,reverse solution of Laplace space bottomhole pressure (equation (74)) to real space bottomhole pressure (equation (75))
for k=1:1
    %Alpha1=e
    Alpha1=0;
    %Alpha2=f
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when beta1=0.002, under closed unpractical outer boundary condition
for k=1:1
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when beta1=0.002, under constant pressure ideal  outer boundary condition
for k=1:1
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when beta1=0.002, under infinity ideal outer boundary condition
for k=1:1
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when beta1=0.002, under elastic outer boundary condition
for k=1:1
